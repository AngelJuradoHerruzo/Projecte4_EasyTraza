...
:toc:
:toclevels: 2
:imagesdir: Documentacio/captures
...
image::login_web.jpg[Pantalla d'inici de sessió de la interfície web, width=900]

==== Gestió d'albarans de proveïdor i OCR

image::ocr_albara_proveidor.jpg[Pantalla de gestió OCR dels albarans de proveïdor, width=900]

==== Explotació de dades

image::explotacio_dades.jpg[Pantalla del gràfic mensual de productes, width=900]

=== Aplicació Mobile

==== Identificació de l'operari

image::identificacio_mobile.jpg[Pantalla d'identificació de l'aplicació Mobile, width=350]

==== Gestió de lots

image::lots_mobile.jpg[Pantalla de gestió de lots de l'aplicació Mobile, width=350]
